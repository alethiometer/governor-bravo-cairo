...
describe("Multi_Vote", () => {
  ...
  describe("transferTo", () => {
    ...
    describe("delegateTo, undelegate, transfer", () => {

      it("delegateTo state updated correctly", async () => {
        await test_user_history(addr1.address, [], [addr1.address, addr2.address, addr3.address])
        await test_user_history(addr2.address, [], [addr1.address, addr2.address, addr3.address])
        await test_user_history(addr3.address, [], [addr1.address, addr2.address, addr3.address])
    ...
    describe("undelegate, and user_history", () => {
        beforeEach(async () => {
            await delegateTo(addr1, addr1.address, 10);
            await delegateTo(addr1, addr2.address, 15);
            await delegateTo(addr1, addr3.address, 20);
